...
@RequestMapping("/api/channel/chart")
@RestController
public class ChannelChartController {
    ...
    public ResponseEntity<Object> todayList(ChannelQueryCriteria criteria, Pageable pageable) {
        return new ResponseEntity<>(channelChartService.findByQueryToday(criteria, pageable), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Object> historyList(ChannelQueryCriteria criteria, Pageable pageable) {
        return new ResponseEntity<>(channelChartService.findByQueryHistory(criteria, pageable), HttpStatus.OK);
    }
