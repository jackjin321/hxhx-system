...
import me.zhengjie.modules.union.config.ProductLoanMatchConfigProperties;
...
//    private StrRedisClient redisClient;
    ...
    protected BaseLoanProductConfigProperties getConfigProperties() {
        LoanProductMatchHandler annotation = this.getClass().getAnnotation(LoanProductMatchHandler.class);
