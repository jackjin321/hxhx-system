package me.zhengjie.union.holder;
...
public class LoanProductMatchHandlerHolder {
    ...
    public static void register(AbstractProductDbMatchHandler<?> handler) {
        ...
        if (Objects.isNull(annotation)) {
            log.warn("{}该类未被[MktProductMatchHandler]注解标注,无法注册", handler.getClass());
            throw new IllegalArgumentException("请标注[MktProductMatchHandler]注解");
        }
