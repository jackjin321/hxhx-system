...
@Table(name = "xf_product_filter_record")
public class ProductFilterRecord extends XFBaseEntity implements Comparable<ProductFilterRecord> {
    ...
    @Override
    public int compareTo(ProductFilterRecord o) {
